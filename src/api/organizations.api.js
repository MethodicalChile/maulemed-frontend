...
export const organizationsApi = {
  ...
  updateOrganization: (uuid, data) =>
    http.patch(`${BASE.organizations}/${uuid}/`, data),
  ...
  updateLegalEntity: (uuid, data) =>
    http.patch(`${BASE.legalEntities}/${uuid}/`, data),
  ...
  updateCostCenter: (uuid, data) =>
    http.patch(`${BASE.costCenters}/${uuid}/`, data),
