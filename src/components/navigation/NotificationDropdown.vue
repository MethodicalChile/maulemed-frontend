...
<template>
  <div class="relative">
    ...
    >
      ...
      <span
        v-if="unreadCount > 0"
        class="absolute top-1.5 right-1.5 flex h-4 min-w-[16px] px-1 items-center justify-center rounded-full bg-destructive text-[10px] font-bold text-white"
      >
    ...
    <div
      v-if="showDropdown"
      class="absolute right-0 mt-2 w-80 bg-white border border-border rounded-lg shadow-lg z-50"
    >
