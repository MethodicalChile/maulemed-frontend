...
<template>
  <header
    class="sticky top-0 z-10 flex h-16 shrink-0 items-center justify-between gap-3 border-b border-border bg-card/80 backdrop-blur-sm px-5"
  >
    <!-- Hamburger mobile -->
    <button
      class="p-2 hover:bg-blue-50 rounded-md md:hidden"
