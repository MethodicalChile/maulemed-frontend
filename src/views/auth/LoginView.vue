...
<template>
  <section class="min-h-screen flex items-center justify-center bg-background p-4 relative">
    ...
    <div class="w-full max-w-sm bg-card/80 backdrop-blur-xl border border-border rounded-2xl shadow-2xl p-8 z-10">
